...
namespace StringTools
{
    ...
    std::string WStringToString(const wchar_t* buffer);
    ...
    void CreateTextOut(HDC hdc, int x, int y, std::wstring str, int fontSize = 11, COLORREF color = RGB(255, 255, 255), std::wstring font = L"±¼¸²Ã¼", UINT center = TA_TOP, bool bold = false);
